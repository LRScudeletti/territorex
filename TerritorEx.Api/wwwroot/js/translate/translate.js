function loadjs(file) {
    ...
    // document.title = resource_globalization["Title"];
    return script;
}
...
function allTranslation() {
    ...
    $.initialize(".info__contact", function () {
        var website = $(this).children("div").children("a").attr("href");
        website = "LinkedIn: " + website;
        $(this).children("div").children("a").html(website);

        var email = $(this).children("a").html();
        email = "Email: " + email.replace("Send email to ", "");
        $(this).children("a").html(email);
    });
    //
    ...
    $(document).click(function (event) {
        ...
        // ReSharper disable once UnknownCssClass
            ...
            target.text(resource_globalization['TryItOut']);
